    ...
    return (
        <div className='play-video'>
            ...
            <div className="play-video-info">
                <p>{value_converter(apiData?.statistics?.viewCount || 0)}&bull; {moment(apiData?.snippet.publishedAt).fromNow()}</p>
                <div>
                    <span><img src={like} alt="" />{value_converter(apiData ? apiData.statistics.likeCount : "16k")}</span>
                    <span><img src={dislike} alt="" /></span>
                    <span><img src={share} alt="" />{value_converter(apiData ? apiData.statistics.shareCount : "1k")}</span>
            ...
            <div className="publisher">
                ...
                <div>
                    ...
                    <span>{value_converter(channelData ? channelData.statistics.subscriberCount : "1.5M")} subscribers</span>
                </div>
